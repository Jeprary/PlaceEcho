...
QA experience renders every positioned Memory Anchor; normal experience mode
dynamically selects the nearest Anchor for capture, proximity, and the matching
Memory Reveal, while localization mode remains locked to its requested target.
The authoring QA page may also recapture the
